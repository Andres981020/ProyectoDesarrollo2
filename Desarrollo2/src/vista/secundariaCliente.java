 ...
 * @author Usuario
 */
public class secundariaCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        eliminarPC = new javax.swing.JButton();
        ...
        getContentPane().add(agregarPC, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, -1, -1));
        ...
        getContentPane().add(modificarPC, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 300, -1, -1));

        eliminarPC.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        eliminarPC.setText("Eliminar");
        eliminarPC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                eliminarPCActionPerformed(evt);
            }
        });
        getContentPane().add(eliminarPC, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 300, -1, -1));
        ...
        getContentPane().add(tipo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 300, 130, -1));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 0, 560, 650));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vista/rojo.jpg"))); // NOI18N
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 20, 630, 320));

        jLabel10.setBackground(new java.awt.Color(255, 255, 255));
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vista/fondoP.jpg"))); // NOI18N
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1260, 680));
    ...
    private void agregarPCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarPCActionPerformed
        ...
        if(tipo1.getSelectedItem().toString().equals("Iniciativa")){
            try {
                ...
                Logger.getLogger(secundariaCliente.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void eliminarPCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarPCActionPerformed
        ...
        if(columna == 1){
            ...
            JOptionPane.showMessageDialog(null,"Eliminacion de la iniciativa satisfactoria");
            secundariaCliente prin = new secundariaCliente();
            prin.setVisible(true);
            dispose();
        }
            ...
            JOptionPane.showMessageDialog(null,"Eliminacion de la meta satisfactoria");
            secundariaCliente prin = new secundariaCliente();
            prin.setVisible(true);
            dispose();
        }   
    }//GEN-LAST:event_eliminarPCActionPerformed
    ...
    private void modificarPCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarPCActionPerformed
        ...
        if(columna == 1){
            ...
            JOptionPane.showMessageDialog(null,"Modificacion del indicador satisfactorio");
            secundariaCliente prin = new secundariaCliente();
            prin.setVisible(true);
            dispose();
        }
        if(columna == 2){
            ...
            JOptionPane.showMessageDialog(null,"Modificacion de la iniciativa satisfactoria");
            secundariaCliente prin = new secundariaCliente();
            prin.setVisible(true);
            dispose();
        }
        ...
        if(columna == 3){
            ...
            JOptionPane.showMessageDialog(null,"Modificacion de la meta satisfactoria");
            secundariaCliente prin = new secundariaCliente();
            prin.setVisible(true);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(secundariaCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new secundariaCliente().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton eliminarPC;
