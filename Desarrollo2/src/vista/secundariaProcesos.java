 ...
 * @author Usuario
 */
public class secundariaProcesos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        agregarPI = new javax.swing.JButton();
        modificarPI = new javax.swing.JButton();
        ...
        agregarPI.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        agregarPI.setText("Agregar");
        agregarPI.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                agregarPIActionPerformed(evt);
            }
        });
        getContentPane().add(agregarPI, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 610, -1, -1));

        modificarPI.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        modificarPI.setText("Modificar");
        modificarPI.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                modificarPIActionPerformed(evt);
            }
        });
        getContentPane().add(modificarPI, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 610, -1, -1));

        eliminarPI.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        eliminarPI.setText("Eliminar");
        eliminarPI.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                eliminarPIActionPerformed(evt);
            }
        });
        getContentPane().add(eliminarPI, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 610, -1, -1));
        ...
        getContentPane().add(tipo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 610, 130, -1));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, -5, 1260, 670));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void agregarPIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarPIActionPerformed
        String objetivo;
    ...
    }//GEN-LAST:event_agregarPIActionPerformed
    ...
    private void modificarPIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarPIActionPerformed
        List<Objetivo> objetivos = objetivoL.objetivosPerspectivaProcesos();
        if(columna == 0){
            String descripcion = (String)perspectivaP.getValueAt(fila, columna);
    ...
    }//GEN-LAST:event_modificarPIActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(secundariaProcesos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new secundariaProcesos().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton agregarPI;
    ...
    private javax.swing.JButton modificarPI;
